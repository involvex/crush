...
This document outlines specific instructions and guidelines for interacting with the Gemini CLI, particularly in the context of the `crush` project.
...
- `npx eslint .`
- `npx prettier . --check`
If one of them return errors, adjust the code, rerun the cycle.
When no errors return, tell the user to push.
